...
sensor_transforms = {
    ...
    "cam_front": carla.Transform(carla.Location(x=1.3, y=0, z=2.3)),
    "cam_front_left": carla.Transform(carla.Location(x=1.3, y=-0.3, z=2.3),carla.Rotation(yaw=-45)),
    "cam_front_right": carla.Transform(carla.Location(x=1.3, y=0.3, z=2.3),carla.Rotation(yaw=45)),
    "cam_back": carla.Transform(carla.Location(x=1.3, y=0, z=2.3)),
    "cam_back_left": carla.Transform(carla.Location(x=-1.3, y=-0.3, z=2.3),carla.Rotation(yaw=135)),
    "cam_back_right": carla.Transform(carla.Location(x=-1.3, y=0.3, z=2.3),carla.Rotation(yaw=-135)),
}
